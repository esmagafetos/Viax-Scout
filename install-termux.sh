...
echo -e "${GREEN}${BOLD}╚════════════════════════════════════════════════╝${NC}"
echo ""
echo -e "  ${BOLD}▶ App Android nativo (ViaX:Trace):${NC}"
echo -e "  ${CYAN}${BOLD}bash ~/viax-system/start-backend.sh${NC}"
echo -e "  (inicia apenas o backend — exibe a URL para colar no app)"
echo ""
echo -e "  ${BOLD}▶ Interface web (navegador):${NC}"
echo -e "  ${CYAN}bash ~/viax-system/start.sh${NC}"
echo -e "  (inicia backend + frontend web)"
echo ""
echo -e "  Para parar:"
